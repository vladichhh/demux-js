...
describe('Action Reader', () => {
    ...
    beforeEach(() => {
        ...
        actionReaderStartAt3 = new TestActionReader_1.TestActionReader({ startAtBlock: 3 });
        actionReaderStartAt3.isInitialized = true;
        actionReaderNegative = new TestActionReader_1.TestActionReader({ startAtBlock: -1 });
    ...
    it('does not seek to block earlier than startAtBlock', () => __awaiter(this, void 0, void 0, function* () {
        ...
        expect(result).rejects.toThrow(errors_1.ImproperStartAtBlockError);
    }));
